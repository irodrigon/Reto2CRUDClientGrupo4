...
public class LoanController {
    ...
    private void initialize() {
        ...
        tcTotalAmount.setCellFactory(TextFieldTableCell.forTableColumn(new DoubleStringConverter() {
            ...
            public Double fromString(String value) {
                try {
                    ...
                    showErrorAlert("Invalid input: ", value);
                    LOGGER.warning("Invalid input: " + value);
                    return previousAmount;
                }
            }
        }));
        ...
        tcStartingDate.setOnEditCommit(event -> {
            ...
            try {
                ...
                LOGGER.warning("Invalid Date: Start date cannot be later than end date.");
        ...
        tcEndingDate.setOnEditCommit(event -> {
            ...
            try {
                ...
                LOGGER.warning("Invalid Date: End date cannot be before start date.");
    ...
    private void configureEditableColumns() {
        tcInterestRate.setOnEditCommit((TableColumn.CellEditEvent<Loan, Integer> event) -> {
            ...
            try {
                ...
                LOGGER.warning("Invalid Input: The interest rate should be an integer greater than 0 and less than 50!");
        ...
        tcPeriod.setOnEditCommit(event -> {
            ...
            try {
                ...
                LOGGER.warning("Invalid Input: Period should be greater than 0 and lower than 1000!");
        ...
        tcTotalAmount.setOnEditCommit(event -> {
            ...
            try {
                ...
                LOGGER.warning("Invalid Input: Amount should be greater than 0 and lower than 100 million!");
    ...
    private void updateLoan(Loan loan) {
        try {
            ...
            LOGGER.log(Level.INFO, "Loan " + loan.getIDProduct()+ "has been succesfully updated");
        } catch (Exception e) {
            showErrorAlert("Error Updating Loan", "Error updating loan: " + e.getMessage());
            LOGGER.warning("Error updating loan: " + e.getMessage());
        }
        loanTable.refresh();
    }
     ...
     */
    @FXML
    private void DeleteLoan(ActionEvent event) throws Exception {
        Loan selectedLoan = loanTable.getSelectionModel().getSelectedItem();
        try {
            if (selectedLoan == null) {
                throw new Exception("No Loan Selected, please select a loan to delete.");
            }
            confirmAndDeleteLoan(selectedLoan);
            
        } catch (Exception e) {
            showErrorAlert("No Loan Selected", "Please select a loan to delete.");
            LOGGER.warning("Error deleting loan: " + e.getMessage());
        }
    }
        ...
        alert.showAndWait().ifPresent(response -> {
            if (response == ButtonType.OK) {
                try {
                    ...
                    mostrarTodosLosPrestamos();
                    LOGGER.log(Level.INFO, "Loan " + selectedLoan.getIDProduct()+ "has been succesfully deleted");
                } catch (Exception e) {
    ...
    private void addNewLoan(ActionEvent event) {
        ...
        try {
            ...
            mostrarTodosLosPrestamos();
            LOGGER.log(Level.INFO, "New loan has been succesfully added");
        } catch (Exception e) {
            LOGGER.warning("Error adding loan: " + e.getMessage());
            showErrorAlert("Error adding loan", e.getMessage());
            //e.printStackTrace();
        }
    }
    ...
    private void PrintLoan(ActionEvent event) {
        try {
            ...
            showErrorAlert("Error printing loan", e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private void mostrarTodosLosPrestamos() {
        try {
            ...
            LOGGER.warning("Error adding data into the table: " + e.getMessage());
            showErrorAlert("Error adding data into the table:", e.getMessage());
        }
    }
    ...
    private void onSearch(ActionEvent event) {
        ...
        try {
            ...
            LOGGER.warning("Error filtering data: " + e.getMessage());
            showErrorAlert("Error filtering data:", e.getMessage());
        }
    ...
    private void Print(ActionEvent event) {
        try {
            ...
            LOGGER.log(Level.WARNING, "AccountController(handlePrintReport): Exception while creating the report {0}", e.getMessage());
            showErrorAlert("Error filtering data:", e.getMessage());
        }
    }
}

...
import com.tartanga.grupo4.main.LoanMain;
...
public class CRUDLoanPassTest1 extends ApplicationTest {
    ...
    public void testC_updateLoanAmount() {
        ...
        clickOn(row);
        Node totalAmountCell = lookup(".table-row-cell").nth(0).lookup(".table-cell").nth(3).query();
    ...
    public void testC_updateLoanInterest() {
        Node row = lookup(".table-row-cell").nth(0).query();
        clickOn(row);
        Node interestCell = lookup(".table-row-cell").nth(0).lookup(".table-cell").nth(5).query();
    ...
    public void testC_updateLoanPeriod() {
        Node row = lookup(".table-row-cell").nth(0).query();
        clickOn(row);
        Node periodCell = lookup(".table-row-cell").nth(0).lookup(".table-cell").nth(6).query();
    ...
    public void testD_deleteLoan() {
        ...
        Long lastID1 = loanTable.getItems().get(initialRowCount - 1).getLoanId();
